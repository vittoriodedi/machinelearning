...
class cat_vs_mouse_Env(Env):
    ...
    def __init__( self, render_mode: Optional[str] = None, desc=None, map_name="10x10"):
        ...
        self.render_human_for_screen = True
        self.render_none_for_screen = False
    ...
    def step(self, a):
        ...
        if self.pygame_initialized:
            ...
            #===============================0
            if self.render_human_for_screen:
                self.render_human_for_screen=False
                self.render_mode='human'

            if self.render_none_for_screen:
                self.render_none_for_screen=False
                self.render_mode=None

            if self.make_screenshot:
                pygame.image.save(self.window_surface, str(self.episode) + ".png")
    ...
    def make_screenshot_fn(self):
        self.make_screenshot = True
    def render_human(self):
        self.render_human_for_screen = True
    def render_none(self):
        self.render_none_for_screen = True
...
def run(episodes, is_training=True, render=False):
    ...
    for i in range(episodes):
        ...
        if i != '---':
            if int(i) == 0 or int(i) == 10 or int(i) == 60 or int(i) == 100 or int(i) == 150 or int(i) == 200 or int(i) == 500 or int(i) == 1000 or int(i) == 2000 or int(i) == 3000 or int(i) == 4000 or int(i) == 5000 or int(i) == 6000 or int(i) == 7000 or int(i) == 7999:
                env.unwrapped.make_screenshot_fn()
            if int(i) == 8 or int(i) == 58 or int(i) == 98 or int(i) == 148 or int(i) == 198 or int(i) == 498 or int(i) == 998 or int(i) == 1998 or int(i) == 2998 or int(i) == 3998 or int(i) == 4998 or int(i) == 5998 or int(i) == 6997 or int(i) == 7998:
                env.unwrapped.render_human()
            if int(i) == 2 or int(i) == 12 or int(i) == 62 or int(i) == 102 or int(i) == 152 or int(i) == 202 or int(i) == 502 or int(i) == 1002 or int(i) == 2002 or int(i) == 3002 or int(i) == 4002 or int(i) == 5002 or int(i) == 6002 or int(i) == 7002:
                print("render NONW")
                env.unwrapped.render_none()
...
run(8000, is_training=True, render=True)